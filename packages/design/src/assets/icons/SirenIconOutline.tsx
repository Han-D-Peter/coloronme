...
export function SirenIconOutline({ width, height, color }: CustomSVGProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M14.583 11.4583L14.583 14.5833" stroke={color} stroke-width="1.5" stroke-linecap="round" />
      <path d="M10.417 11.4583L10.417 14.5833" stroke={color} stroke-width="1.5" stroke-linecap="round" />
      <path
