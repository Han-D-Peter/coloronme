...
import { color, colorLibrary, Modal, Text } from '@design';
import { useRouter } from 'next/router';
import { useMyColor } from '@/src/domains/shared/hooks/queryhooks/color/color.query';
import SeasonColorCatBox from '@/src/domains/color/SeasonColorCatBox';
import { SEASONS } from '@/src/domains/shared/constants/color';
...
export default function Colors() {
  const { data, isLoading } = useMyColor();
  ...
  return (
    <DefaultLayout>
      ...
      <div
        ...
        `}
      >
        <SeasonColorCatBox season="spring" colors={data.data!['spring']} />
        <SeasonColorCatBox season="summer" colors={data.data!['summer']} />
        <SeasonColorCatBox season="autumn" colors={data.data!['autumn']} />
        <SeasonColorCatBox season="winter" colors={data.data!['winter']} />
      </div>
    </DefaultLayout>
  );
